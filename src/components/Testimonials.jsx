...
const testimonials = [
  {
    ...
    text: 'The stay at MGM Residency was absolutely breathtaking. Waking up to misty coffee hills every morning with world-class service made it a trip we will never forget.',
  },
  {
    name: 'Alisha Martin',
    location: 'Rome / Italy',
    ...
    text: 'Exceptional hospitality, stunning views, and a room that felt like home. The staff went above and beyond to ensure every moment of our trip was perfect.',
  },
  {
    name: 'Rahul Sharma',
